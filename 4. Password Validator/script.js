...
function textChange(){
  if(password.value.match(/[A-Z]/) != null) valid('capital', 'fa-check', 'fa-times');
  else  invalid('capital', 'fa-check', 'fa-times');
  if(password.value.match(/[0-9]/) != null) valid('num', 'fa-check', 'fa-times');
  else  invalid('num', 'fa-check', 'fa-times');
  if(password.value.match(/[!@#$%^&*]/) != null) valid('char', 'fa-check', 'fa-times');
